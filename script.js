...
let fiveLetter = strings.filter(function(item){
...
let seven = ranks.findIndex(function(item){
  return item === 7
})
console.log(seven)
...
let result = marks.some(function(item){
  return item<45
})
console.log(result)
...
let check = positive.every(function(item){
  return item>0
});
console.log(check);
